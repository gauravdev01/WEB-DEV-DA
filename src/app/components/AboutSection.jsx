...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>VIT Univeristy, Vellore [B.tech (Computer Science and Business Systems)]</li>
        <li>Doon Public School, Patna [12th Boards (Majored in Physics, Chemistry, Mathematics)]</li>
        <li>St. Karens School,Patna [10th Boards]</li>
      </ul>
    ),
  },
  {
